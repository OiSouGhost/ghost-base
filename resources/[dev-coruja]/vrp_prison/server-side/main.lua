	...
	if user_id then
		if vRP.hasPermission(user_id,"Police") then
			...
			if identity then
				...
				TriggerClientEvent("Notify",nuser_id,"importante","Você foi preso por  <b>"..parseInt(services).." serviços</b>.",5000)
...
function cRP.callPolice()
	...
	for k,v in pairs(copAmount) do
		async(function()
			TriggerClientEvent("Notify",v,"importante","Encontramos um fugitivo do presídio, intercept o mesmo.",5000)
		end)
	end

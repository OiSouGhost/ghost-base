...
RegisterCommand('skin',function(source,args,rawCommand)
	...
	if vRP.hasPermission(user_id,"Owner") then
		...
		TriggerClientEvent("Notify",source,"importante","Voce setou a skin <b>"..args[2].."</b> no passaporte <b>"..parseInt(args[1]).."</b>.",5000)
    end
end)
-----------------------------------------------------------------------------------------------------------------------------------------
-- ITEM
...
RegisterCommand("wl",function(source,args,rawCommand)
	...
	if user_id then
		if vRP.hasPermission(user_id,"Admin") then
			...
			TriggerClientEvent("Notify",source,"importante","Você aprovou a Hex "..args[1]..".",5000)

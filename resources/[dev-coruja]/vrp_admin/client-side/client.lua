...
function cnVRP.setDiscord(status)
    SetDiscordAppId(976606171291086878)
    SetDiscordRichPresenceAsset('logo')
    SetDiscordRichPresenceAssetText('SKZ ROLEPLAY')
    SetDiscordRichPresenceAction(0, "DISCORD", "https://discord.gg/59G6xUxBpD")

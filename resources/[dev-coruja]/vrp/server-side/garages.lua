...
local vehglobal = {
	...
	-----------------------------------------
	["WRS911"] = { "Speed Policia",20,100,nil },
	["WRScayp"] = { "Nc 750x",20,100,nil },
	["WRSpanam"] = { "Panamera Policia",20,100,nil },
	["wrspanam2"] = { "Panamera 2 Policia",20,100,nil },
	["wrssierra"] = { "Sierra Policia",20,100,nil },
	["wrstrx"] = { "Ram Policia",20,100,nil },
	["wrscb500x"] = { "CB 500X Policia",20,100,nil },
	["wrsk9"] = { "Van Policia",20,100,nil },
	["WRSursa"] = { "Ursa Policia",20,100,nil }
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- VEHICLEGLOBAL
-----------------------------------------------------------------------------------------------------------------------------------------

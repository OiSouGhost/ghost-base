...
-----------------------------------------------------------------------------------------------------------------------------------------
cnVRP = {}
Tunnel.bindInterface("vrp_lumberman",cnVRP)
			...
			if inService then
				...
				if not IsPedInAnyVehicle(ped) then
					...
					if collectDis <= 30 then
						timeDistance = 4
						DrawText3Ds(collect[coSelected][1],collect[coSelected][2],collect[coSelected][3],"~g~E~w~   COLETAR")
					...
					if deliverDis <= 100 then
						timeDistance = 4
						DrawText3Ds(deliver[deSelected][1],deliver[deSelected][2],deliver[deSelected][3],"~g~E~w~   ENTREGAR")
...
function collectBlipMarked()
	...
	AddTextComponentString("Coletar Madeira")
...
function deliverBlipMarked()
	...
	BeginTextCommandSetBlipName("STRING")
	AddTextComponentString("Entregar Madeira")

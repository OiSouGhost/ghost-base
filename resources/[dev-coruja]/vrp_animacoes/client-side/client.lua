...
-----------------------------------------------------------------------------------------------------------------------------------------
local animacoes = {
	["moeda"] = { dict = "anim@mp_player_intcelebrationmale@coin_roll_and_toss" , anim = "coin_roll_and_toss" , andar = true , loop = false },
	...
	["pneu"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "imp_prop_impexp_tyre_01b", flag = 50, mao = 28422 },	["pneu"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "imp_prop_impexp_tyre_01b", flag = 50, mao = 28422 },
	["roda"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "imp_prop_impexp_wheel_01a", flag = 50, mao = 28422 },
	["motor"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "imp_prop_impexp_engine_part_01a", flag = 50, mao = 28422 },
	["colete"] = { dict = "anim@heists@box_carry@", anim = "idle", prop = "prop_bodyarmour_05", flag = 50, mao = 28422 },
...
AddEventHandler("emotes",function(nome)
	local ped = PlayerPedId()
	if animacoes[nome] and not IsPedShooting(ped,6) then
		if (GetEntityHealth(ped) > 101 or nome == "checkin") and vSERVER.checkInventory() then
			vRP.removeObjects("one")
